...
> อัปเดตล่าสุด: 2026-09-01 — **Phase 0b: A0–A11 + module API + LLM harness เสร็จ · 719 tests**
> **ต่อกับโมเดลจริงแล้ว — Typhoon** (`typhoon-v2.5-30b-a3b-instruct`, ดู `plans/08_TYPHOON.md`)
> การต่อจริงเจอบั๊ก 5 ตัวที่ตัวแทนสคริปต์ไม่เคยเจอ แก้แล้วทั้งหมด แต่ **ยังไม่มีรอบวัดเดียวที่ครบ
> ทั้ง 3 dev seeds หลังแก้บั๊กครบ** — เลข detail ล่าสุดที่วัดได้ (**0.0133** ก่อนแก้บั๊กตัวที่กระทบแรงสุด)
> ต้องรันซ้ำก่อนอ้างเป็นทางการ ดู `plans/07_LLM_HARNESS.md` §5.5
