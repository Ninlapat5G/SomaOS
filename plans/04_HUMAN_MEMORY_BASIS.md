...
## 14. ต้นไม้อ่าน "ความลึกของโครงสร้าง" จากข้อมูลได้เอง — ถึงประมาณ 4 ชั้น

> `python -m somaos.bench.experiments.depth` · เทสต์คุมที่ `tests/test_structural_depth.py`

§13 ทิ้งคำถามไว้ว่า **สามชั้นคือคำตอบ หรือแค่คำถามที่เราบังเอิญถาม?**
เลยสร้างโลกที่ลึก 2/3/4/5 ชั้น ขนาดพอ ๆ กัน (~250 ชิ้น) แล้วดูว่าโครงสร้างที่โผล่มาเองตามหรือไม่

| โลกลึก | แยกชั้นออกได้จริง | เรียงถูก |
|---|---|---|
| 2 ชั้น | **2 จาก 2** | ✅ |
| 3 ชั้น | **3 จาก 3** | ✅ |
| 4 ชั้น | **4 จาก 4** | ✅ |
| 5 ชั้น | **4 จาก 5** (บาง seed ได้ 5) | ✅ |

**นิ่งทั้ง 3 seed** · ชั้นกว้างสุดไม่เคยเสื่อมเลยทุกโลกทุกขนาดคลัง · ชั้นแคบสุดตกลงหาค่าเดาสุ่มแต่ไม่เคยต่ำกว่า

### ความหมาย

**ระบบไม่ได้ถูกล็อกไว้ที่ 3 ชั้น** — มันอ่านความลึกออกมาจากข้อมูล
แปลว่า agent ไม่ต้องถูกบอกล่วงหน้าว่าโดเมนของมันมีโครงสร้างกี่ชั้น

### เพดานที่วัดได้ และเหตุผล

ที่ 5 ชั้น สองชั้นล่างสุดมักกองรวมกัน — เพราะ concept ที่ติดกันใช้ชื่อร่วมกัน 4 จาก 5 ตัว
เวกเตอร์จึงใกล้กันมากจนการบีบอัดพรากไปพร้อมกัน **บันทึกไว้เป็นขีดจำกัดที่วัดได้ ไม่ใช่นำเสนอเป็นความสำเร็จ**

⚠️ ข้อจำกัดเดียวกับ §13: โลกสังเคราะห์ · โครงสร้างชั้นในข้อมูลเราใส่เอง · ยังไม่เทียบข้อมูลมนุษย์จริง
